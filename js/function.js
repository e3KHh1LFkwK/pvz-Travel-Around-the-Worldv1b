...
PlaySubtitle = (str, delay) => {
  ...
  oS.Lvl == 'Egypt1' && (PlaySubtitle(), ClearChild($('PointerUD2')));
  SetNone($("Menu"));
  ...
  if (/Egypt/.test(lvl)) {
    //埃及
    return num < 5 ? `Egypt${num + 1}`: 'Egypt5';
  }
...
oMiniGames = {
  ...
  */
  ConveyorBelt(arrP = oS.PName, createTime = 600, moveTime = 3, priorityP = [], maxCard = 10) {
    /* 一些初始化 */
    let bgDom = NewImg("imgKK", "images/interface/ConveyorBelt.gif", "left:-107px;top:0px;z-index:0; ", $('dCardList'));
