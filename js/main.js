...
let $User = {
        ...
        'Monitor'(a) {
            ...
            (function d() {
                ...
                let a = 0x1, b = NewEle('', 'canvas', 'position:absolute;left:0;top:0;width:900px;height:600px;pointer-events:none;z-index:' + 0x3 * (oS['R'] + 0x1), {
                        'width': Math['floor'](0x384 * a),
                        'height': Math['floor'](0x258 * a)
                    }, EDPZ), c = b['getContext']('2d');
                c['globalAlpha'] = 0.7;
                let d = {
                        'width': 0x32,
                        'height': 0x3
                ...
                function f(h, i, j, k) {
                    c['fillRect'](Math['round'](h * a), Math['round'](i * a), Math['round'](j * a), Math['round'](k * a));
                }
                const g = () => {
                    c['clearRect'](0x0, 0x0, Math['floor'](0x384 * a), Math['floor'](0x258 * a));
                    let h = [], j = [];
                    c['fillStyle'] = '#31312f';
                    let k;
                    for (let m of $Z) {
                        if (m['CanDrawBlood']) {
                            var l;
                            let n = {
                                'x': m['X'] + (m['beAttackedPointL'] + m['beAttackedPointR']) / 0x2,
                                'y': m['pixelTop'] + ((l = m['HeadTargetPosition'][m['isAttacking']]) !== null && l !== void 0x0 ? l : m['HeadTargetPosition'][0x0])['y'] - 0xa - d['height'],
                                'HPRatio': Math['max'](0x1, ((m['constructor']['prototype']['HP'] - m['BreakPoint']) / 0x1f4) ** 0x1 / 0x3)
                            };
                            n['x'] -= d['width'] * n['HPRatio'] / 0x2;
                            let o = ![];
                            if (m['OrnHP'] > 0x0 && m['OrnHP'] < (k = m['constructor']['prototype']['OrnHP'])) {
                                let p = Object['assign']({ 'ratio': m['OrnHP'] / k }, n);
                                p['HPRatio'] = Math['max'](0x1, (k / 0x1f4) ** 0x1 / 0x3), p['y'] += e, j['push'](p), f(p['x'] - 0x2, p['y'] - 0x2, d['width'] * p['HPRatio'] + 0x4, d['height'] + 0x4), o = !![];
                            }
                            (m['HP'] < (k = m['constructor']['prototype']['HP']) || o) && m['HP'] >= m['BreakPoint'] && (h['push'](Object['assign']({ 'ratio': (m['HP'] - m['BreakPoint']) / (k - m['BreakPoint']) }, n)), f(n['x'] - 0x2, n['y'] - 0x2, d['width'] * n['HPRatio'] + 0x4, d['height'] + 0x4));
                        }
                    }
                    for (let q of $P) {
                        let r = {
                            'x': q['pixelLeft'] + q['width'] / 0x2,
                            'y': GetY(q['R']) - d['height'] - 0x5f - q['Stature'] * 0x14,
                            'HPRatio': Math['max'](0x1, ((k = q['constructor']['prototype']['HP']) / 0x3e8) ** 0x1 / 0x4)
                        };
                        r['x'] -= d['width'] * r['HPRatio'] / 0x2, q['HP'] < k && q['HP'] > 0x0 && (r['ratio'] = Math['min'](q['HP'] / k, 0x1), h['push'](r), f(r['x'] - 0x2, r['y'] - 0x2, d['width'] * r['HPRatio'] + 0x4, d['height'] + 0x4));
                    }
                    c['fillStyle'] = '#2aff00';
                    for (let t = h['length'] - 0x1; t >= 0x0; t--) {
                        f(h[t]['x'], h[t]['y'], d['width'] * h[t]['ratio'] * h[t]['HPRatio'], d['height']);
                    }
                    c['fillStyle'] = '#4ab8f6';
                    for (let u = j['length'] - 0x1; u >= 0x0; u--) {
                        f(j[u]['x'], j[u]['y'], d['width'] * j[u]['ratio'] * j[u]['HPRatio'], d['height']);
                    }
                    return Math['floor'](($User['LowPerformanceMode'] ? 1.2 : 0x1) * oSym['NowSpeed'] * Math['min'](Math['max']((h['length'] + j['length']) * 0x2 / 0x3, 0xa), 0x96));
                };
                (function h() {
                    oSym['addTask'](g(), h);
                }());
