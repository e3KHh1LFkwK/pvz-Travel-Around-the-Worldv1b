...
oEgyptLawnCleaner = InheritO(oLawnCleaner, {
  EName: "oEgyptLawnCleaner",
  PicArr: ["images/interface/EgyptLawnCleaner.png", "images/Card/LawnCleaner.webp", 'images/Plants/SporeShroom/Effect.webp'],
}),
...
oPeashooterleft = InheritO(oPeashooter, {
  EName: "oPeashooterleft",
  PicArr: function () {
    var a = "images/Plants/Peashooter/";
    var b = "images/Plants/";
    return ["images/Card/Peashooter.webp", a + "0.webp", a + "Peashooterleft.gif", b + "PB00.webp", b + "PeaBulletHit0.webp", a + "PeashooterAttack.webp"];
  }(),
}),
  ...
  PicArr: function () {
    ...
    return ["images/Card/PotatoMine.webp", a + "0.gif", a + "PotatoMineNotReady.gif", a + "PotatoMine.gif", a + "Boom.png", a + "PotatoMineOut.gif"];
  }(),
  Tooltip: $__language_Array__["e5534a553c736ae39f0819c8c5917d3c"],
  Story: $__language_Array__["8f90e0eadc55b5abe8b482caade98a5a"],
  Status: 0,
  AudioArr: ["cherrybomb"],
  getShadow: self => `left:1px;top:50px;`,
  canTrigger: 0,
  ...
  NormalAttack: function (lx, rx, r) {
    ...
    oEffects.ImgSpriter({
      ele: NewEle(id + '_Boom', "div", `position:absolute;overflow:hidden;z-index:${self.zIndex + 2};width:178px;height:190px;left:${self.pixelLeft - 50}px;top:${self.pixelTop - 10}px;background:url(images/Plants/PotatoMine/Boom.png) no-repeat;`, 0, EDPZ),
      styleProperty: 'X',
      changeValue: -213,
      frameNum: 14,
      interval: 8
...
//埃及植物从以下开始
oBonkChoy = InheritO(CPlants, {
  EName: "oBonkChoy",
  CName: $__language_Array__["BonkChoy"],
  width: 127,
  height: 174,
  beAttackedPointL: 8,
  beAttackedPointR: 45,
  ...
  AudioArr: ["bonk"],
  PicArr: function () {
    var a = "images/Plants/BonkChoy/";
    return ["images/Card/BonkChoy.png", a + "0.png", a + "BonkChoy.gif", a + "BonkChoyAttack.gif"];
  }(),
  Attack: 32,
  Tooltip: $__language_Array__["BonkChoy_Descriptilon"],
  Story: $__language_Array__["BonkChoy_Flavor"],
  ...
  NormalAttack: function () {
    ...
    let self = this,
        ...
        zombies = oZ.getArZ(self.AttackedLX, Math.min(self.AttackedRX + 100, oS.W), self.R);
...
oSunShroom = InheritO(CPlants, {
  ...
  PicArr: function () {
    ...
    return ["images/Card/SunShroom.webp", a + "0.webp", a + "SunShroom3.gif", a + "SunShroom2.webp", a + "SunShroom.webp", a + "SunShroomGrow2.gif", a + "SunShroomGrow.webp", a +"ProduceSun.webp"];
  }(),
  ...
  PicArr: function () {
    ...
    return ["images/Card/FumeShroom.webp", a + "0.png", a + "FumeShroom.webp", a + "FumeShroomAttack.webp", a + "FumeShroomBullet.webp"];
  }(),
  AudioArr: ["fume"],
...
oFlowerPot = InheritO(CPlants, {
  ...
  HP: 300,
  getShadow: self => "left:1px;top:1px" + (self.height - 1) + "px;",
  PicArr: ["images/Card/FlowerPot.webp", "images/Plants/FlowerPot/FlowerPot.png", "images/Plants/FlowerPot/FlowerPot.gif"],
  PKind: 0,
  Stature: -1,
...
//能量瓷砖
oLinktile_01 = InheritO(oStoneFlower, {
  EName: "oLinktile_01",
  CName: $__language_Array__["af6179d978e3b00051ca5fa4adcea183"],
  width: 90,
  height: 85,
  ...
  Story: $__language_Array__["8e97e48e644a247155f827dab4db4f04"],
  PicArr: function () {
    var a = "images/Props/linktile_01/";
    return ["images/Card/linktile_01.png", a + "0.png", a + "idle.gif", a + "Attack.gif"];
  }(),
  GetDX: self => -Math.floor(self.width * 0.5) - 10,
  getShadow: self => `left:5px;top:6.5px;`,
  PrivateBirth: function (o) {
