...
var CZombies = NewO({
  ...
  BoomGIF(left, top) {
    ...
    let self = this;
    oEffects.ImgSpriter({
      ele: NewEle(self.id + '_Boom', "div", `position:absolute;overflow:hidden;z-index:${self.zIndex + 2};width:380px;height:613px;left:${left}px;top:${top}px;background:url(images/Zombies/Boom.png) no-repeat;`, 0, EDPZ),
      styleProperty: 'X',
      changeValue: -196,
      frameNum: 51
    });
...
oZombie = InheritO(OrnNoneZombies, {
  ...
  getShadow: function (a) {
    return "left:45px;top:" + (a.height - 15) + "px;";
  },
  PicArr: function () {
...
oFlagZombie = InheritO(OrnNoneZombies, {
  EName: "oFlagZombie",
  CName: $__language_Array__["FlagZombie"],
  StandGif: 8,
  Lvl: 1,
  BoomDieGif: 9,
  width: 359,
  height: 214,
  beAttackedPointL: 128,
  beAttackedPointR: 148,
  Speed: 2,
  Almanac: {
    Tip: $__language_Array__["FlagZombie_Descriptilon"],
    Story: $__language_Array__["FlagZombie_Flavor"]
  },
  GetCardImg() {
    let self = this;
    return "images/Card/FlagZombie.png";
  },
  BirthCallBack(self) {
    PlayAudio("groan_" + Math.floor(1 + Math.random() * 6));
    OrnNoneZombies.prototype.BirthCallBack(self);
  },
  getShadow: self => "left:145px;top:" + (self.height - 15) + "px;",
  PicArr: (a => ["", "", a + "Zombie.gif", a + "ZombieAttack.gif", a + "ZombieLostHead.gif", a + "ZombieLostHeadAttack.gif", a + "ZombieHead.webp", a + "ZombieDie.gif", a + "1.gif", 'images/Zombies/BoomDie.webp'])("images/Zombies/FlagZombie/"),
  GoingDieHead(id, PicArr, self) {
    CZombies.prototype.GoingDieHeadNew(id, PicArr, self, {
      top: self.pixelTop + 44,
      left: self.X + 80,
...
oPoleVaultingZombie = InheritO(OrnNoneZombies, {
  ...
  CName: $__language_Array__["PoleVaultingZombie"],
  Lvl: 2,
  width: 16,
  height: 154,
  OSpeed: 1.5,
  ...
  PicArr: function () {
    ...
    return ["", "", a + "ZombieAttack.webp", a + "ZombieLostHead.webp", a + "ZombieLostHeadAttack.webp", a + "ZombieHead.webp", a + "ZombieDie.webp", a + "ZombieWalk.webp", a + "ZombieLostHeadWalk.webp", a + "ZombieAttack.webp", a + "Zombie.webp", a + "1.webp", 'images/Zombies/BoomDie.webp'];
  }(),
  Almanac: {
    Tip: $__language_Array__["PoleVaultingZombie_Descriptilon"],
    Speed: $__language_Array__["f936d5500c4364fd956a7d7aebc96324"],
    Story: $__language_Array__["PoleVaultingZombie_Flavor"]
  },
  GetCardImg() {
    let self = this;
    return "images/Card/UnknownZombie.png";
  },
  ...
  NormalAttack: function (d, b, g) {
    var f = $Z[d],
        ...
        c = f.EleShadow,
        e = f.EleBody;
    e.src = "images/Zombies/Zombie/ZombieAttack.webp";
    SetHidden(c);
    f.isAttacking = 2;
    f.Altitude = 2;
    ...
    oSym.addTask(100, function (m, j, i, l, n) {
      ...
      if (h) {
        ...
        h.AttackedRX = (h.X = (h.AttackedLX = h.ZX = q = k.AttackedRX) - h.beAttackedPointL) + h.beAttackedPointR, SetStyle(i, {
          left: h.X + "px"
        }), n.src = "images/Zombies/Zombie/ZombieAttack.webp", SetVisible(l), h.isAttacking = 0, h.Altitude = 1, h.OSpeed = h.Speed = 1.6, h.NormalGif = 7, h.LostHeadGif = 8, h.NormalAttack = (r = CZombies.prototype).NormalAttack, h.getCrushed = r.getCrushed, h.getFreeze = r.getFreeze, h.getRaven = r.getRaven, h.HeadTargetPosition[0].x += 30) : ( //普通植物
        h.ZX = h.AttackedLX = (h.X = (h.AttackedRX = g) - h.beAttackedPointR) + h.beAttackedPointL, SetStyle(i, {
          left: h.X + "px"
        }), n.src = "images/Zombies/Zombie/Zombie.webp", SetVisible(l), oSym.addTask(80, function (s, v) {
          var u = $Z[s],
              t;
          u && (v.src = "images/Zombies/Zombie/Zombie.webp", u.isAttacking = 0, u.Altitude = 1, u.OSpeed = u.Speed = 1.6, u.NormalGif = 7, u.LostHeadGif = 8, u.HeadTargetPosition[0].x += 30, u.NormalAttack = (t = CZombies.prototype).NormalAttack, u.getCrushed = t.getCrushed, u.getFreeze = t.getFreeze, u.getRaven = t.getRaven);
        }, [m, n]));
      }
    }, [d, b, a, c, e]);
  },
...
oBrickZombie = InheritO(oBucketheadZombie, {
  EName: "oBrickZombie",
  CName: $__language_Array__["BrickZombie"],
  OrnHP: 2200,
  Lvl: 4,
  width: 216,
  height: 154,
  ...
  beAttackedPointR: 128,
  Almanac: {
    Tip: $__language_Array__["BrickZombie_Descriptilon"],
    Story: $__language_Array__["BrickZombie_Flavor"]
  },
  getShadow: function (a) {
    return "left:45px;top:" + (a.height - 15) + "px;";
  },
  AudioArr: ["Brick", "Brick2", "Brick3", "Brick4"],
  PlayNormalballAudio: function () {
    PlayAudio(["Brick", "Brick2", "Brick3", "Brick4"][Math.floor(Math.random() * 4)]);
  },
  GetCardImg() {
    let self = this;
    return "images/Card/BrickZombie.png";
  },
  PicArr: function () {
    var b = "images/Zombies/BrickZombie/",
        a = "images/Zombies/Zombie/";
    return ["", "", b + "BrickZombie.gif", b + "BrickZombieAttack.gif", a + "ZombieLostHead.webp", a + "ZombieLostHeadAttack.webp", a + "ZombieHead.webp", a + "ZombieDie.webp", a + "Zombie.webp", a + "ZombieAttack.webp", b + "1.gif", 'images/Zombies/BoomDie.webp'];
  }()
}),
    //埃及僵尸从以下开始
    oRaZombie = InheritO(OrnNoneZombies, {
      EName: "oRaZombie",
      CName: $__language_Array__["RaZombie"],
      StandGif: 8,
      BoomDieGif: 9,
      width: 216,
      height: 224,
      ...
      beAttackedPointR: 128,
      Almanac: {
        Tip: $__language_Array__["RaZombie_Descriptilon"],
        Story: $__language_Array__["RaZombie_Flavor"]
      },
      getShadow: self => "left:115px;top:" + (self.height - 15) + "px;",
      PicArr: (a => ["", "", a + "RaZombie.gif", a + "RaZombieAttack.gif", a + "ZombieLostHead.gif", a + "ZombieLostHeadAttack.gif", a + "ZombieHead.png", a + "RaZombieDie.gif", a + "1.gif", 'images/Zombies/BoomDie.webp'])("images/Zombies/RaZombie/"),
      ...
      CustomBirth: function (i, c, d, m) {
        ...
        NewImg(e + "_Light", "images/RaZombie/RaZombieSuckSun.gif", "left:" + (g.AttackedLX - g.beAttackedPointL) + "px;top:" + g.pixelTop + "px;z-index:" + g.zIndex, EDPZ); //初始化发光特效
      ...
      GetCardImg() {
        let self = this;
        return "images/Card/RaZombie.png";
      },
      GoingDieHead(id, PicArr, self) {
        CZombies.prototype.GoingDieHeadNew(id, PicArr, self, {
          top: self.pixelTop + 44,
    ...
    oExplorerZombie = InheritO(oZombie, {
      EName: "oExplorerZombie",
      ...
      //头的位置数据
      PicArr: (a => [a + "zombie.webp", a + "ZombieAttack.webp", a + "ZombieLostHead.webp", a + "ZombieLostHeadAttack.webp", a + "ZombieHead.webp", a + "ZombieDie.webp", a + "zombie2.webp", a + 'filling.webp', 'images/Zombies/BoomDie.webp'])("images/Zombies/PushIceImp/"),
      ...
      Fill(obj, bingku) {
        CustomSpecial(oSnowPea, bingku.R, bingku.C); //调用冰封海棠填冰
    ...
    oPharaohZombie = InheritO(OrnIZombies, {
      EName: "oPharaohZombie",
      CName: $__language_Array__["PharaohZombie"],
      OrnHP: 1200,
      HP: 400,
      Lvl: 3,
      LostPaperGif: 11,
      ...
      LostPaperAttack: 200,
      Almanac: {
        Tip: $__language_Array__["PharaohZombie_Descriptilon"],
        Story: $__language_Array__["PharaohZombie_Flavor"]
      },
    
      GetCardImg() {
        let self = this;
        return "images/Card/" + self.EName.substr(1).split("_")[0] + ".png";
      },
    
      PicArr: function () {
        var a = "images/Zombies/PharaohZombie/";
        return ["", "", a + "HeadWalk1.gif", a + "HeadAttack1.gif", a + "LostHeadWalk.gif", a + "LostHeadAttack.gif", a + "HeadWalk0.gif", a + "HeadAttack0.gif", a + "LostHeadWalk0.gif", a + "LostHeadAttack0.gif", a + "Head.png", a + "Die.gif", a + "LostNewspaper.gif", a + "1.gif ", 'images/Zombies/BoomDie.webp'];
      }(),
      AudioArr: ["CamelPanel_Break1"],
      getShadow: function (a) {
        return "left:115px;top:" + (a.height - 25) + "px;";
      },
      ...
      CheckOrnHP: function (g, h, d, c, f, b, a) {
        ...
        if ((g.OrnHP = d -= c) < 1) {
          ...
          oSym.addTask(150, function (m, l) {
            ...
            PlayAudio(["Pharaoh_rarrgh", "Pharaoh_rarrgh2"][Math.round(Math.random() * 1)]);
            k.EleBody.src = l;
            k.JudgeAttack();
    ...
    //秦陵僵尸从以下开始
    oCavalryZombie = InheritO(OrnNoneZombies, {
      EName: "oCavalryZombie",
      CName: $__language_Array__["CavalryZombie"],
      HP: 300,
      StandGif: 8,
      BoomDieGif: 9,
      width: 216,
      ...
      beAttackedPointR: 128,
      Speed: 2.2,
      AudioArr: ["Zombie_rider_skill_move"],
      Almanac: {
        Tip: $__language_Array__["CavalryZombie_Descriptilon"],
        Story: $__language_Array__["CavalryZombie_Flavor"],
        Speed: $__language_Array__["426447ca47ebfe6eaced0f4182bda3d9"]
      },
      getShadow: self => "left:55px;top:" + (self.height - 15) + "px;",
      PicArr: (a => ["", "", a + "Zombie.gif", a + "ZombieAttack.gif", a + "ZombieLostHead.gif", a + "ZombieLostHeadAttack.gif", a + "ZombieHead.png", a + "ZombieDie.gif", a + "1.gif", 'images/Zombies/BoomDie.webp'])("images/Zombies/CavalryZombie/"),
      GetCardImg() {
        let self = this;
        return "images/Card/CavalryZombie.png";
      },
      GoingDieHead(id, PicArr, self) {
        CZombies.prototype.GoingDieHeadNew(id, PicArr, self, {
          top: self.pixelTop + 44,
    ...
    //未来僵尸从以下开始
    oJetpackZombie = InheritO(OrnNoneZombies, {
      EName: "oJetpackZombie",
      CName: $__language_Array__["JetpackZombie"],
      StandGif: 8,
      BoomDieGif: 9,
      width: 216,
      height: 724,
      ...
      Altitude: 2,
      Almanac: {
        Tip: $__language_Array__["JetpackZombie_Descriptilon"],
        Story: $__language_Array__["JetpackZombie_Flavor"]
      },
      getShadow: self => "left:45px;top:" + (self.height - 15) + "px;",
      PicArr: (a => ["", "", a + "1.gif", a + "Attack.gif", a + "LostHead.gif", a + "ZombieLostHeadAttack.webp", a + "Head.png", a + "Die.gif", a + "1.gif", 'images/Zombies/BoomDie.webp'])("images/Zombies/JetpackZombie/"),
      HeadTargetPosition: [{
        x: 170,
        y: 150
      }, {
...
oJackinTheBoxZombie = InheritO(OrnNoneZombies, {
  ...
  PicArr: function () {
    ...
    return ["", "", a + "Attack.gif", a + "Die.gif", a + "1.gif", a + "Walk.gif", a + "OpenBox.gif", "images/Zombies/JackinTheBoxZombie/Boom.gif", a + "LostHead.gif", a + "LostHeadAttack.gif", a + "Head.gif", 'images/Zombies/BoomDie.webp'];
  }(),
  Almanac: {
    Tip: $__language_Array__["77677e560511898b362060cdfadaec73"],
    Weakness: $__language_Array__["f937bc5afe4fab3de791d0123059a38f"],
...
oSculptorZombie = InheritO(oZombie, {
  ...
  //头的位置数据
  getShadow: self => `left:${self.beAttackedPointL - 25}px;top:${self.height - 122}px;`,
  getDisplayShadow: self => `left:${self.beAttackedPointL - 25}px;top:${self.displayHeight - 122}px;`,
  PicArr: (path => ["", path + "idle.gif", path + 'drop.gif', path + 'Zombie.gif', path + 'run_full.webp', path + 'catch.webp', path + 'eat.gif', path + 'die.gif', path + 'head.png'])("images/Zombies/RelichunterZombie/").concat('images/Zombies/BoomDie.webp'),
  getCharredCSS: self => ({
    left: `19px`,
    top: `16px`,
