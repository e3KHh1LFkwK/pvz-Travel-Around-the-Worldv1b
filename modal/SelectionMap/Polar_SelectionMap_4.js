...
oSelectionMap.loadPage({
  ...
  LoadAccess($c, $box) {
    ...
    NewImg("imgSF", "images/interface/PolarClue1.webp", "left:3798190px;top:30px;transform: scale(0.12);", $box, {
    ...
    NewImg("imgSF", "images/interface/PolarClue2.webp", "left: 2380525px;top:-25px;transform: scale(0.12);", $box, {
    ...
    NewEle(null, 'div', 'left: 4789495px;top: 337px;', {
      className: 'Shadow'
    }, $box);
    NewEle(null, 'div', 'left: 483760px;top: 295px;', {
      className: 'Shadow'
    }, $box);
  }
