...
oSelectionMap.loadPage({
  ...
  LoadAccess($c, $box) {
    ...
    NewImg("imgSF", "images/interface/Conical_flask.png", "left: 9580125px;top: 490160px;clip: rect(138px,118px,auto,60px);", $box, {
    ...
    NewEle(null, 'div', 'top: 480355px;left: 170px;', {
      className: 'Shadow'
    }, $box);
  }
