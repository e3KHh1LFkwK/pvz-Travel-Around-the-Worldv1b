...
oSelectionMap.loadPage({
  ...
  LoadAccess($c, $box) {
    ...
    NewImg("imgSF", "images/interface/MarshClue2.webp", "left: 988228px;top: 80910px;transform: scale(0.18);", $box, {
