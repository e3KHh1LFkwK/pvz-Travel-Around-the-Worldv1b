...
oSelectionMap.loadPage({
  ...
  LoadAccess($c, $box) {
    ...
    NewImg("imgSF", "images/interface/Conical_flask.png", "left: 76458280px;top: 145px;clip: rect(138px,118px,auto,60px);", $box, {
