...
!sessionStorage['PVZTR_Almanac_Page'] ? oS['Init']({
    ...
    'LoadAccess': function () {
        let a = NewImg('', 'images/Plants/SunFlower/idle.webp', 'position:absolute;top:300px;left:200px;', EDAll), b = NewImg('', 'images/Zombies/Zombie/1.webp', 'position:absolute;top:250px;left:600px;', EDAll);
    ...
    'LoadAccess': function () {
        ...
        NewEle('', 'a', 'left:1px;bottom:3px;height:38px;text-align:center;color:white;line-height:38px;font-size:14px;width:103px;z-index:258;position:\x20absolute;background:url(images/interface/Almanac_IndexButton.png);background-size:cover;', {
            'className': 'jngButton',
