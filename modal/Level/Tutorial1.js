...
oS.Init({
  ...
  LoadAccess: function (a) {
    loadRes({
      img: ['images/interface/background1unsodded2.webp', 'images/interface/backgroundModern.jpg']
    });
      ...
      switch (d) {
        ...
        case 3:
          ...
          case 4:
            ...
            innerText(c, $__language_Array__["Tutorial1_Dave_5"]);
            break;
  ...
  AZ: [[oZombie, 5, 1], [oFlagZombie, 0, 5, [5]]],
  FlagNum: 5,
  FlagToSumNum: {
    a1: [4],
    a2: [1, 5]
