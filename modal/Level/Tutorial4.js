...
oS.Init({
  ...
  ZName: [oZombie, oConeheadZombie, oBucketheadZombie, oPoleVaultingZombie, oFlagZombie],
  PicArr: function () {
    return ["images/interface/background1unsodded2.webp", "images/interface/background1.webp", "images/interface/ChiliSauce.webp"];
  }(),
  ...
  AZ: [[oZombie, 4, 1], [oConeheadZombie, 3, 4], [oBucketheadZombie, 1, 5], [oPoleVaultingZombie, 1, 7], [oFlagZombie, 0, 9, [9]]],
  FlagNum: 9,
  FlagToSumNum: {
    a1: [5, 7, 8],
    a2: [1, 4, 8, 1]
  ...
  FlagToEnd: function () {
    ...
    NewImg("imgSF", "images/interface/ChiliSauce.webp", "left:0px;top:0px;clip:rect(auto,auto,80px,auto)", dom, {
      onclick: function () {
        ClearChild(dom2);
        GetNewProp(this, 'ChiliSauce', $__language_Array__["38e3f30133993accab2cb06d6e952845"], $__language_Array__["dd8062125104febc79bb947d2eaa690f"], 'Egypt1', '200px', '400px');
      }
    });
    ShowWinItem(dom);
  }
